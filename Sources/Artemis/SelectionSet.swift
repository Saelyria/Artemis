...
*/
public protocol Selection: AnySelection {
	/// The object type that the fields selected from this aggregate are on.
    associatedtype T: Object
	/// The combined 'result' of the selected field(s). For example, in the above example selection set of 'name' and
...
*/
public protocol AnySelection {
	var items: [AnySelection] { get }
	var renderedFragmentDeclarations: [String] { get }
	var error: GraphQLError? { get }
	func render() -> String
}
public extension AnySelection {
...
public struct SelectionSet<T: Object, Result>: Selection {
