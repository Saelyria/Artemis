...
extension TestInterface2_Bool_RenderTests {
    func testMultipleSingleOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i2_bool,i2_bool}}")
    }
    ...
    func testMultipleSingleArgsOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i2_boolArgs\(testArgs),i2_boolArgs\(testArgs)}}")
    }
    ...
    func testMultipleArrayOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i2_bools,i2_bools}}")
    }
    ...
    func testMultipleArrayArgsOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i2_boolsArgs\(testArgs),i2_boolsArgs\(testArgs)}}")
    }
}
