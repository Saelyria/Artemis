...
extension TestInterface3_Int_RenderTests {
    ...
    func testArrayArgsRender() {
        ...
        XCTAssertEqual(query.render(), "{i3_intsArgs\(testArgs)}")
    }
}
...
extension TestInterface3_Int_RenderTests {
    ...
    func testArrayAliasRender() {
        ...
        XCTAssertEqual(query.render(), "{alias:i3_ints}")
    }
    ...
    func testArrayArgsAliasRender() {
        ...
        XCTAssertEqual(query.render(), "{alias:i3_intsArgs\(testArgs)}")
    }
}
...
extension TestInterface3_Int_RenderTests {
    func testMultipleSingleRender() {
        ...
        XCTAssertEqual(query.render(), "{i3_int,i3_int}")
    }
    ...
    func testMultipleSingleArgsRender() {
        ...
        XCTAssertEqual(query.render(), "{i3_intArgs\(testArgs),i3_intArgs\(testArgs)}")
    }
    ...
    func testMultipleArrayRender() {
        ...
        XCTAssertEqual(query.render(), "{i3_ints,i3_ints}")
    }
    ...
    func testMultipleArrayArgsRender() {
        ...
        XCTAssertEqual(query.render(), "{i3_intsArgs\(testArgs),i3_intsArgs\(testArgs)}")
    }
}
...
extension TestInterface3_Int_RenderTests {
    ...
    func testArrayArgsOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i3_intsArgs\(testArgs)}}")
    }
}
...
extension TestInterface3_Int_RenderTests {
    ...
    func testArrayArgsAliasOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{alias:i3_intsArgs\(testArgs)}}")
    }
}
...
extension TestInterface3_Int_RenderTests {
    func testMultipleSingleOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i3_int,i3_int}}")
    }
    ...
    func testMultipleSingleArgsOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i3_intArgs\(testArgs),i3_intArgs\(testArgs)}}")
    }
    ...
    func testMultipleArrayOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i3_ints,i3_ints}}")
    }
    ...
    func testMultipleArrayArgsOnObjectRender() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i3_intsArgs\(testArgs),i3_intsArgs\(testArgs)}}")
    }
}
...
extension TestInterface3_Int_RenderTests {
    ...
    func testArrayArgsOnFragmentRender() {
        ...
        XCTAssertEqual(query.render(), "{...fragName},fragment fragName on Query{i3_intsArgs\(testArgs)}")
    }
}
