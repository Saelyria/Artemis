...
extension TestInterface3_Float_TypeTests {
    ...
    func testOptional() {
        ...
        {
            "data": {
                "i3_floatOptional": 1.23
            }
        }
        """.utf8)

        XCTAssertEqual(query.render(), "{i3_floatOptional}")
        let res = try? query.createResult(from: response)
        XCTAssertEqual(res, 1.23)
    }
}
...
extension TestInterface3_Float_TypeTests {
    ...
    func testOptionalOnObject() {
        ...
        XCTAssertEqual(query.render(), "{testObject{i3_floatOptional}}")
        let res: Partial<TestObject>? = try? query.createResult(from: response)
        XCTAssertEqual(res?.values.count, 1)
        XCTAssertEqual(res?.i3_floatOptional, 1.23)
    }
...
extension TestInterface3_Float_TypeTests {
    func testSingleAliasOnObject() throws {
        ...
        let res: Partial<TestObject>? = try? query.createResult(from: response)
        XCTAssertEqual(res?.values.count, 1)
        let aliased = res?.i3_float(alias: "alias")
    ...
    func testSingleArgsAliasOnObject() throws {
        ...
        let res: Partial<TestObject>? = try? query.createResult(from: response)
        XCTAssertEqual(res?.values.count, 1)
        let aliased = res?.i3_floatArgs(alias: "alias")
        XCTAssertEqual(aliased, 1.23)
    }
    ...
    func testArrayAliasOnObject() throws {
        ...
        let res: Partial<TestObject>? = try? query.createResult(from: response)
        XCTAssertEqual(res?.values.count, 1)
        let aliased = res?.i3_floats(alias: "alias")
...
extension TestInterface3_Float_TypeTests {
    ...
    func testOptionalOnFragment() {
        ...
        XCTAssertEqual(query.render(), "{...fragName},fragment fragName on Query{i3_floatOptional}")
        let res = try? query.createResult(from: response)
        XCTAssertEqual(res, 1.23)
    }
}
...
extension TestInterface3_Float_TypeTests {
    ...
    func testOptionalOnObjectFragment() {
        ...
        XCTAssertEqual(query.render(), "{testObjectOptional{...fragName}},fragment fragName on TestInterface3{i3_float}")
        let res: Partial<TestObject>? = try? query.createResult(from: response)
        XCTAssertEqual(res?.values.count, 1)
        XCTAssertEqual(res?.i3_float, 1.23)
    }
